...
const DetailsPage = () => {
    return (
        <div className='pt-12 px-2 bg-white'>
            ...
            <Image src={"/product.jpg"} width={400} height={400} alt='product image' className='bg-black' />
            <Carousel>
                <CarouselContent>
            ...
            <div className='pt-4'>
                <div className='flex flex-col'>
                    <div className='flex items-center'>
                        <p className='text-sm text-gray-500 line-through'><span>Rs.</span>15,000.00</p>
                        <Badge className='text-sm scale-75'>33% off</Badge>
                    </div>
                    <p className='font-bold text-3xl'><span>Rs.</span>10,000.00</p>
                </div>
            ...
            <div className='pt-4'>
                <Tabs defaultValue='reviews' className='w-[95vw]'>
                    ...
                    <TabsContent value='description'>
                        ...
                        The Fire Mask (“Gini Raksha”) is used in Sri Lankan festivals and cultural dances and also used as a home decoration while protecting from weird hazards which is a cultural belief among Sri Lankans. This wooden mask is painted in vibrant colors, with bulging eyes and protruding tongues.
                        </p>
