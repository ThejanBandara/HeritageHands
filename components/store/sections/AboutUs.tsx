...
const AboutUs = () => {
  return (
    <div className='mt-12'>
      <div className='px-4 bg-gray-50 bg-opacity-75 md:px-32 md:py-8'>
        <h1 className='text-lg md:text-2xl font-bold'>About Us</h1>

        <p className='text-left md:px-12 mt-2 md:text-lg'>
      ...
      <div className='mt-8 w-full bg-gray-300 px-6 md:px-32 py-4 flex flex-col'>
