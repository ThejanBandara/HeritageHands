...
const Footer = () => {
  return (
    <div className='bg-gray-300 flex flex-col px-4 py-4 items-center gap-4'>
      <Image src={'/logolong.png'} width={200} height={200} alt='logo' />
      ...
      <div className='flex gap-1 flex-wrap items-center justify-center'>
        ...
        <p> | </p>
        <Link href={'/'} className=' text-nowrap'>About Us</Link>
        <p> | </p>
        <Link href={'/'} className=' text-nowrap'>Contact Us</Link>
      </div>

      <div className='flex flex-col gap-0 items-center justify-center'>
        <p className='text-sm text-gray-600'>&copy; 2024 HeritageHands.inc All Rights Reserved</p>
        <p className='text-sm text-gray-600'> Developed by <a className='underline' href="https://www.thejanbandara.com">Thejan Bandara</a></p>
      </div>
    </div>
  )
}
